...
const paragraphs = [
  ...
  'earlier this year, i joined an overseas agency. it was a game-changing experience, where i generated over ₹3 lakh in revenue for the agency. <a href="/past" class="text-sky-500 underline">although i eventually moved on</a>, my passion for creating hasn\'t wavered one bit.',
