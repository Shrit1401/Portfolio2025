...
const Newsletter: React.FC<NewsletterProps> = ({ className = "" }) => {
  return (
    ...
    >
      ...
      />
      <button
        className="px-8 py-3 w-full md:w-auto bg-[#37517b] text-white rounded-full hover:bg-[#6B46C1] transition-all duration-300 font-medium shadow-sm hover:shadow-md active:scale-95 relative overflow-hidden group-hover:translate-x-1"
        onClick={() => {
